...
const Service = ({service}) => {
    ...
    return (
        <div className="max-w-xs rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100 overflow-hidden">
	...
	<div className="flex flex-col justify-between p-6 space-y-8">
		<div className="space-y-2">
			...
			<p className="dark:text-gray-100">{serviceDetails?.slice(0,100)}</p>
		</div>

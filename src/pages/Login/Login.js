...
const Login = () => {
    ...
    const handleEmailLogin=(event)=>{
        ...
        .then(result=>{
            ...
            fetch(`https://b6a11-service-review-server-side-noyon-ahammad-khan.vercel.app/jwt`,{
                method:'POST',
                headers:{
    ...
    return (
        <div className="w-full mr-auto ml-auto max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
        <h1 className="text-2xl font-bold text-center">Login</h1>
        <form onSubmit={handleEmailLogin} noValidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
